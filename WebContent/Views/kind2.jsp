...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            <h4>数据列表</h4>
            <div class="add"><a class="btn btn-success" href="<%=basePath %>/Views/kind3.jsp">添加</a></div>
            <div class="w">
                <div class="span12">
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                          	<c:forEach var="kind" items="${ kindlist}">
                           	 	<tr>
                        			<th>${kind.kind_name} </th>
                        			<th>${kind.kind_id} </th>
                        			<th>
                        				<a href="<%=basePath %>/Views/kind4.jsp?kind_name=${kind.kind_name}">修改</a> | 
                        				<a href="<%=basePath %>/../deletekind.do?kind_id=${kind.kind_id}">删除</a>
                        			</th>
                               </tr>
                       		</c:forEach>
                        </tbody>
