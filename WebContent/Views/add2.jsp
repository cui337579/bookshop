...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="w">
                <div class="span12">
              		<form action="<%=basePath %>/../insert.do">
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		...
                        		<th> <input type="file" name="book_img"> </th>
                        		<th> <input type="text" name="book_author"> </th>
                       		<tr> 
                        </tbody>
                    ...
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		<th> <input type="text" name="book_describe"> </th>
                        		<th> 
                        		...
                        		<th> <input type="text" name="book_price"> </th>
                        		<th> <input type="submit" value="添加图书"> </th>
                       		<tr> 
                        </tbody>
