...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="w">
                <div class="span12">
              		<form action="<%=basePath %>/../updatesubmit.do">
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		<th> <input type="text" name="book_name" value="${book.book_name }"> </th>
                        		<th> <input type="file" name="book_img" value="${book.book_img }"> </th>
                        		<th> <input type="text" name="book_author" value="${book.book_author }"> </th>
                       		<tr> 
                        </tbody>
                    ...
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		<th> <input type="text" name="book_describe" value="${book.book_describe }"> </th>
                        		<th> 
                        			<select name="book_kind">
                        			 	<c:forEach var="kind" items="${ kindlist}">
                        			 		<c:choose>
                        			 			<c:when test="${kind.kind_id == book.kind.kind_id }">
  													<option value ="${kind.kind_id}" selected="selected">${kind.kind_name }</option>
  												</c:when>
  												<c:otherwise>
                        		...
                        		<th> <input type="text" name="book_price" value="${book.book_price }"> </th>
