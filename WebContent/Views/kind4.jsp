...
request.getSession().setAttribute("kind_name",request.getParameter("kind_name"));
%>
<head>
...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="w">
                <div class="span12">
              		<form action="<%=basePath %>/../updatekind.do">
                    <table class="table table-condensed table-bordered table-hover tab" >
                        ...
                        <tbody id="tbody">
                            <tr align="center">
                        		<th> <input type="text" name="kind_name" value = "${kind_name }"></th>
                        		<th> <input type="submit" value="修改类别"></th>
                       		<tr> 
                        </tbody>
